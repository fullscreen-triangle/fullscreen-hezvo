...
const SprintVisualization = ({ rawData }) => {
    ...
    children: data
      ...
      .map((athlete) => ({
        ...
        children: [
          ...
          {
            name: "20-40m",
            value: parseFloat(athlete.t20_40.replace(",", ".")),
          },
          {
            name: "40-60m",
            value: parseFloat(athlete.t40_60.replace(",", ".")),
          },
          {
            name: "60-80m",
            value: parseFloat(athlete.t60_80.replace(",", ".")),
          },
          {
            name: "80-100m",
            value: parseFloat(athlete.t80_100.replace(",", ".")),
          },
        ],
      })),
  };
...
export default SprintVisualization;
