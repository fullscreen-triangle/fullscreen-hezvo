...
export const CircularPackingDatasetTransitionDemo = ({ width = 700, height = 400, }) => {
    ...
    return (<>
      ...
      <CircularPackingDatasetTransition width={width} height={height - BUTTONS_HEIGHT - 20} data={dataset}/>
    </>);
};
