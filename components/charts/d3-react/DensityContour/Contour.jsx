...
export const Contour = ({ width, height, data }) => {
    ...
    const allShapes = contourData.map((contour, i) => {
        return (<path key={i} d={d3.geoPath()(contour)} opacity={1} stroke={"none"} fill={colorScale(contour.value)} fillOpacity={opacityScale(contour.value)}/>);
    });
    return (<div>
