...
export const Histogram = ({ width, height, data }) => {
    ...
    const allRects = buckets.map((bucket, i) => {
        ...
        return (<Rectangle key={i} x={xScale(x0) + BUCKET_PADDING / 2} width={xScale(x1) - xScale(x0) - BUCKET_PADDING} y={yScale(bucket.length)} height={boundsHeight - yScale(bucket.length)}/>);
    });
